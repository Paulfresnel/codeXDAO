    ...
    <div className={styles.nft_gallery_page_container}>
      <div className={styles.nft_gallery}>
        <div className={styles.nfts_display}>
          {nfts?.length ? (
            nfts.map((nft) => {
              return <NftCard chain={chain} key={nft.tokenId} nft={nft} />;
            })
          ) : (
      ...
      <div className={styles.info_container}>
        ...
        <div className={styles.symbol_contract_container}>
          ...
          <div className={styles.contract_container}>
            ...
            {chain.includes('ETH') ? <a href={`https://opensea.io/assets/ethereum/${nft.contract}/${nft.tokenId}`}>            
            <img
